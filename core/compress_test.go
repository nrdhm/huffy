...
var compressTestCases = []compressTest{
	{
		clear:      "abc",
		compressed: "Qf+BAwEBCEh1ZmZUcmVlAf+CAAEFAQRaZXJvAf+CAAEDT25lAf+CAAEDU3ltAQwAAQNDbnQBBAABA0VPRgECAAAAKP+CAQEDAWEBAgABAwFiAQIAAgQAAQEDAWMBAgABBAIBAQACBAACCADY",
	},
	{
		clear:      "",
		compressed: "",
